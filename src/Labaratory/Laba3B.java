...
//1) нужно найти количество отрицательных чисел в строке в которой имеется 0 элемент
//2) номер срок и столбцов всех седловых точек матрицы

import Methods.MyRandom;
import Methods.NegativeNumber;
import Methods.SaddlePoint;
